...
class AnimeCharacterSelectorTests(unittest.TestCase):
    ...
    def test_bundles_revised_wai_v16_list(self) -> None:
        self.assertEqual(5434, len(selector._CHARACTER_MAP))
        self.assertEqual(5435, len(selector._CHINESE_OPTIONS))
        self.assertEqual(5435, len(selector._ENGLISH_OPTIONS))
